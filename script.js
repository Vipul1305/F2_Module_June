  ...
  students.forEach((student) => {
    ...
    row.innerHTML = `
        ...
        <td id="both">
          ${student.degree}
          <div>
            <img src="./utils/edit 1.png" alt="Edit" class="edit-icon" data-id="${student.ID}"/>
            <img src="./utils/trash-2 1.png" alt="Delete" class="delete-icon" onclick="deleteStudent(${student.ID})" data-id="${student.ID}"/>
          </div>
        </td>
      `
